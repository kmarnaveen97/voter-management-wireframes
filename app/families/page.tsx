            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-muted/50">
                  <TableHead
                    className="w-16 font-medium cursor-pointer hover:bg-muted/80 transition-colors"
                  ...
                  <TableHead className="w-24 font-medium">Gender</TableHead>
                ...
                {sortedFamilies.map((family, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell>
                        <Link
                          href={`/family-mapping?ward=${family.ward_no}&house=${family.house_no}`}
                          className="inline-flex h-7 w-7 items-center justify-center rounded text-muted-foreground opacity-0 group-hover:opacity-100 hover:bg-muted hover:text-foreground transition-all"
                        >

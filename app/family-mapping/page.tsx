  ...
  return (
    <TooltipProvider delayDuration={300}>
      ...
      >
        ...
        <div
          className={cn(
            "bg-gradient-to-br from-primary to-primary/80 text-primary-foreground relative overflow-hidden",
            isCollapsed ? "p-3" : "p-5"
          )}
        >
          {/* Background pattern */}
        ...
        {/* Footer Stats */}
        {!isCollapsed && (
          <div className="p-3 border-t border-border bg-gradient-to-t from-muted/50 to-transparent">
            ...
            {/* Keyboard hint */}
            <div className="mt-2 pt-2 border-t border-border/50 flex items-center justify-center gap-3 text-[10px] text-muted-foreground">
              <span className="flex items-center gap-1">
                <kbd className="px-1.5 py-0.5 bg-muted rounded text-[9px] font-mono">
                  ↑↓
                </kbd>
                Navigate
              </span>
    ...
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <div className="flex-1 flex flex-col relative h-full">
        ...
        <div className="absolute top-0 left-0 right-0 z-10 p-4 pointer-events-none">
          <div className="bg-card/90 backdrop-blur-sm border border-border rounded-xl shadow-sm p-4 flex justify-between items-center max-w-4xl mx-auto pointer-events-auto">
            <div>
          ...
          >
            {loadingMembers ? (
              ...
              <div className="flex flex-col items-center text-muted-foreground">
                ...
                <p>Select a family from the sidebar to view the tree</p>
              </div>
            ) : familyTree.length > 0 ? (
        ...
        <div className="absolute bottom-6 right-6 z-10 pointer-events-none">
          <div className="bg-card/90 backdrop-blur-sm p-3 rounded-xl border border-border shadow-lg pointer-events-auto">
            ...
            <div className="space-y-2 text-xs font-medium text-foreground">
              ...
              <div className="flex items-center gap-2">
                <div className="w-3 h-0.5 bg-pink-300"></div>
                Spouse Link
              </div>
            </div>
          </div>

...
export default function FamiliesError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Families module error:", error);
  }, [error]);
    ...
    <div className="flex items-center justify-center min-h-[50vh] p-4">
      <Card className="max-w-md w-full">
        <CardHeader className="text-center">
          ...
          <CardTitle>Failed to Load Families</CardTitle>
        </CardHeader>
        <CardContent className="text-center space-y-4">
          <p className="text-muted-foreground">
            Unable to load family tree data. Please check your connection and
            try again.
          </p>

...
export default function VotersError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Voters module error:", error);
  }, [error]);
    ...
    <div className="flex items-center justify-center min-h-[50vh] p-4">
      <Card className="max-w-md w-full">
        <CardHeader className="text-center">
          ...
          <CardTitle>Failed to Load Voters</CardTitle>
        </CardHeader>
        <CardContent className="text-center space-y-4">
          <p className="text-muted-foreground">
            Unable to load voter data. This could be a network issue or the
